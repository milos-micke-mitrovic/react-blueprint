...
<Callout type="info">
  This pattern allows you to refactor internal file structure without breaking imports elsewhere.
</Callout>
...
<Callout type="warning">
  Circular dependencies cause bugs and make refactoring difficult. Use tools like `madge` to detect them.
</Callout>
