---
description: React testing patterns - unit tests, integration tests, component testing with React Testing Library, mocking, and test-driven development best practices.
---
